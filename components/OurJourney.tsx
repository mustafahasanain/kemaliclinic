  ...
  return (
    <section id="journey" className="py-16" ref={ref}>
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          <div className="space-y-6">
            ...
            <p className="text-text-gray">
              ...
              نبدأ باستشارة طبية لتقييم حالتك، ثم نرسل لك خطة علاج مفصلة تشمل
              التكاليف والمدة. بعد تأكيدك، نقوم بحجز موعد العملية والفندق
              المناسب لإقامتك.
            </p>
        ...
        <motion.div
          initial={{ opacity: 0, y: 50 }} // starts 50px below
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }} // animates upward
          transition={{ duration: 0.7 }}
